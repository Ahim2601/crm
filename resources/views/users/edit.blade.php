        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="formCategory" class="needs-validation" action="{{ route('user.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="mb-6 col-md-4">
                                    <div class="form-floating form-floating-outline">
                                        <select id="rol" name="rol" class="form-select select2"
                                            ...
                                            <option value="{{ $rol->name }}" {{ $data->hasRole($rol->name) ? 'selected' : ''  }} >{{ $rol->name }}</option>
                                            @endforeach
                                        </select>
